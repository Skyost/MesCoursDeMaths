...
export interface ContentGeneratorSettings {
  ...
  getMarkdownLinkedResources (directory: string, file: string, pdfDestURL: string): MarkdownResource[],
  getMarkdownLinkedResourceTitle (prefix: string, file: string): string | null,
  ignored: string[]
}
