...
<template>
  <div>
    ...
    <protected>
      ...
      <agenda-application-navigation-entry />
...
import AgendaApplicationNavigationEntry from '~/components/Page/Navigation/Entries/AgendaApplicationNavigationEntry'

export default {
  components: { PageHead, TeacherNavigationEntry, Calendar, Protected, Spinner, SkiButton, SkiModal, ErrorDisplay, CodeEditor, AgendaApplicationNavigationEntry },
  data () {
    return {
      currentDate: null,
      modalLoading: false,
