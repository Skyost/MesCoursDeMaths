...
\\begin{document}
  ...
  {extractedContent}
\\end{document}
`},filterFileName:t=>{let a="-cours";return t.endsWith(a)?t.substring(0,t.length-a.length):(a="-cours-impression",t.endsWith(a)?t.substring(0,t.length-a.length)+"-impression":t)},getLinkedResources:(t,a)=>{const e=k(a);if(e.endsWith("-cours")){const n=[],r=h.filterFileName(e),c=o.readdirSync(o.dirname(a)),u=(i,f)=>`/${h.latexPdfDestinationDirectory}/${i}/${h.filterFileName(k(f))}.pdf`;for(const i of c)if(i.startsWith(r)&&i.endsWith(".tex")&&i!==e){const f=o.relative(o.resolve(t,h.downloadDestinations.data,h.dataLatexDirectory),a),y=o.dirname(f).replace("\\","/");e+".tex"===i&&n.push({title:"Télécharger le PDF",url:u(y,i),isCurrentFile:!0});const g=Ce(r,i);g&&n.push({title:g,url:u(y,i)})}return n}return[]}},Ce=(t,a)=>{const e=[{fileNameRegex:RegExp(t+/-activite-([A-Za-zÀ-ÖØ-öø-ÿ\d, ]+)/.source),buildTitle:n=>`Activité ${n[1]}`},{fileNameRegex:RegExp(t+/-evaluation/.source),buildTitle:n=>"Évaluation"},{fileNameRegex:RegExp(t+/-interrogation/.source),buildTitle:n=>"Interrogation"},{fileNameRegex:RegExp(t+/-dm/.source),buildTitle:n=>"Devoir maison"}];for(const n of e){const r=n.fileNameRegex.exec(a);if(r!=null)return n.buildTitle(r)}return null},ze={key:0},we={key:1},Le=["textContent"],Be={class:"d-flex align-items-center gap-3"},De=["innerHTML"],Ne=["innerHTML"],Re={key:2},Ae=t=>({title:t.name,to:W(t),depth:1}),Ue=C({__name:"index",setup(t){const a=ee(),e=z[a.params.level.toString()],{status:n,data:r,error:c}=he(a.path,()=>ve(h.dataLatexDirectory,e==null?void 0:e.id).without("body").sort({number:1,$numeric:!0}).find(),"$qztm8S4CJV"),u=v(()=>e?`Cours de ${e.name}`:"Liste des cours");R(_e),e&&R(Ae(e));const i=te(!1),f=g=>g.url.endsWith(".pdf")?"bi:file-earmark-pdf-fill":"bi:file-earmark-text-fill",y=g=>g.url.endsWith(".pdf")?"danger":null;return(g,d)=>{const w=oe,E=re,q=le,G=ie,H=ue,I=de,M=ce,j=me,U=be,Z=ye,P=ge,J=se;return m(),x("div",null,[p(w,{title:s(u)},null,8,["title"]),s(n)==="pending"?(m(),x("div",ze,[p(E)])):s(e)&&s(r)?(m(),x("div",we,[p(G,null,{default:_(()=>[p(q,null,{default:_(()=>[p(N,{to:"/cours/",text:"Retourner à la liste des niveaux"}),s(e).otherResources&&s(e).otherResources.length>0?(m(),$(N,{key:0,text:"Autres ressources","icon-id":"file-earmark-text-fill",onClick:d[0]||(d[0]=l=>i.value=!s(i))})):L("",!0)]),_:1})]),_:1}),b("h1",{textContent:ae(s(u))},null,8,Le),p(M,{class:"justify-content-center"},{default:_(()=>[(m(!0),x(B,null,D(s(r),l=>(m(),$(I,{key:l.id,xs:"12",md:"6",lg:"4",class:"mt-3"},{default:_(()=>[p(H,{title:l.name,color:s(e).color,subtitle:s(xe)(l),to:s(ke)(l),image:s($e)(l)},null,8,["title","color","subtitle","to","image"])]),_:2},1024))),128))]),_:1}),s(e).otherResources&&s(e).otherResources.length>0?(m(),$(P,{key:0,modelValue:s(i),"onUpdate:modelValue":d[1]||(d[1]=l=>ne(i)?i.value=l:null),title:"Autres ressources",size:"lg","ok-only":"","ok-title":"Fermer","ok-variant":"secondary"},{default:_(()=>[d[2]||(d[2]=b("p",null," Ce niveau comporte d'autres ressources qui ne sont pas associées à un chapitre particulier. ",-1)),p(Z,{class:"mb-3"},{default:_(()=>[(m(!0),x(B,null,D(s(e).otherResources,l=>(m(),$(U,{key:l.url,href:l.url},{default:_(()=>[b("div",Be,[b("div",{class:V(["fs-2",{[`text-${y(l)}`]:y(l)}])},[p(j,{name:f(l)},null,8,["name"])],2),b("div",null,[b("strong",{class:"d-block",innerHTML:l.name},null,8,De),b("small",{innerHTML:l.description},null,8,Ne)])])]),_:2},1032,["href"]))),128))]),_:1})]),_:1},8,["modelValue"])):L("",!0)])):(m(),x("div",Re,[p(J,{"change-title":!0,error:s(c)??404},null,8,["error"])]))])}}});export{Ue as _,ke as g,Ae as l,h as s};
