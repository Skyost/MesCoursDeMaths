...
<template>
  <div>
    ...
    <h1 v-text="title" />
    <p>
      Vous pouvez continuer votre navigation en allant sur <a href="#" @click.prevent="goBack">la page précédente</a>
      ou en allant sur <nuxt-link to="/">la page d'accueil</nuxt-link>.
